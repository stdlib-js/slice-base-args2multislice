...
```javascript
args2multislice = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/slice-base-args2multislice@v0.1.0-umd/browser.js' )
```
...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/slice-base-args2multislice@v0.1.0-umd/browser.js"></script>
```
